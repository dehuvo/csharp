...
class CommandExam {
  public static void Main() {
    string str = "Provider=OraOLEDB.Oracle;data source=topcredu;User ID = scott; Password = tiger";
    OleDbConnection Conn = new OleDbConnection(str);
    Conn.Open();
    OleDbDataAdapter adapter = new OleDbDataAdapter("select * from emp order by empno", Conn);
